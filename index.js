...
function get20s(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    const yaerArray = array[i].years.split('-');
    if (yaerArray[0] > 1900 && yaerArray[1] > 1900) {
...
function addArtist(array) {
  const me = {
    ...
    genere: "Web Design",
    nationality: "Italian",
    bio: "I have only just begun my journey in tech and I am quite excited for what is to come"
  }
  array.push(me);
  return array
}
